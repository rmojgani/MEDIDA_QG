...
if IF_TEST_NONOISE:
    ...
    GAMMA_DIFF=0.00
    GAMMA_LAPL=0.00    
    NUM_EPOCHS_ADAM = 10123
NUM_EPOCHS_ADAM2 = 200123
from myfilters import plotfft 
#mylabel = 'interp2'; 
from smoothplot import myplot2
ENDPOINT=False

interp_type = 'mlp' #['rbf', 'griddata', 'mlp']
mylabel = interp_type
...
try:
    ...
    print('Checkpoint loaded: ', folder_path_load+file_name_load+myiter+'.pth' )
except:
    print('no checkpoint')
    ...
    if IF_TRAIN_R:
        ...
        if interp_type =='mlp':
            ...
            if IF_LOADNET2:
                ...
                print('Net2 loaded.')
                file_name=file_name+'_contd'+str(NUM_EPOCHS_ADAM2)
...
fig, ax= plt.subplots(nrows=1, ncols=2, figsize=(12,4), dpi=500)

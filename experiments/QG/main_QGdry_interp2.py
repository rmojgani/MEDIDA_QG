...
mylabel = 'interp2'; EPSILON = 0.10
from smoothplot import myplot2

interp_type = 'rbf' #['rbf', 'griddata']
# 'rbf' : multiquadric:
if interp_type == 'rbf':
...
for LAYER in [1,2]:
    ...
    TOL = 1e-9
    # THRESHOLD_ALPHA = 1e3
    for THRESHOLD_ALPHA in [1e-2, 1e-1, 1e0, 1e1, 1e2, 1e3, 1e4]:
        print('---\n')
        print('alpha:', THRESHOLD_ALPHA, '\n')
